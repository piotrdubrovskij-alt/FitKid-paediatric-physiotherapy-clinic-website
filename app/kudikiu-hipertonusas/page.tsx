...
export default function KudikiuHipertonusasPage() {
  ...
  const txt = {
    lt: {
      ...
      introDesc: 'Kūdikių hipertonusas (padidėjęs raumenų tonusas) yra dažna priežastis, kodėl tėvai kreipiasi į vaikų kineziterapeutą. Dalis kūdikių iš tiesų pereina per trumpą padidėjusios įtampos etapą, tačiau kai įtampa išlieka, didėja ar trukdo judesių raidai, verta nelaukti.',
      introLabel: 'Šiame puslapyje aiškiai paaiškiname:',
      introItems: ['kaip atpažinti hipertonusą namuose;','kuo skiriasi „laikina įtampa" nuo būklės, kurią reikia koreguoti;','kada reikalinga skubi gydytojo konsultacija;','kaip FitKid klinikoje Vilniuje vyksta įvertinimas ir terapija.'],
      shortTitle: 'Trumpas atsakymas tėvams',
      shortText: 'Hipertonusas reiškia, kad kūdikio raumenys yra per daug įtempti ramybės būsenoje. Dėl to kūdikis gali atrodyti „standus", dažniau riečiasi atgal, sunkiau atsipalaiduoja, gali prasčiau miegoti, sunkiau išlaikyti patogias pozas maitinimo ar perrengimo metu. Ne kiekvienas įtampos požymis reiškia neurologinę ligą. Tačiau jei simptomai kartojasi, trukdo kasdienybei ar raidai, reikia įvertinimo. Ankstyva korekcija dažniausiai duoda geriausią rezultatą, nes pirmaisiais mėnesiais nervų sistema yra labai plastiška.',
      whatTitle: 'Kas yra raumenų tonusas ir kada jis laikomas padidėjusiu',
      whatText: 'Raumenų tonusas yra natūrali, nuolatinė raumenų įtampa, padedanti išlaikyti kūno padėtį ir pasiruošti judesiui. Normalus tonusas yra būtinas. Problema atsiranda tada, kai tonusas tampa per didelis ir riboja kokybišką judesį.',
      ...
      signsTitle: 'Hipertonuso požymiai pagal amžių',
      ages: [
      ...
      finalDesc: 'Jei įtariate hipertonusą ar matote, kad kūdikio judesiai tampa standūs ir įtempti, registruokitės į įvertinimą.',
    ...
    en: {
      ...
      whatTitle: 'What is Muscle Tone and When is it Elevated',
      ...
      signsTitle: 'Signs of Hypertonia by Age',
      ages: [
      ...
      causesTitle: 'Why Hypertonia Occurs',
      ...
      therapyGoalNote: 'In hypertonia correction the goal is not to just relax. The goal is:',
      ...
      finalDesc: 'If you suspect hypertonia or notice that the infant\'s movements are becoming stiff and tense, register for assessment.',
      ...
      <main className="pt-20">
        ...
        <section className="relative flex items-center bg-[#e8e6e3]" style={{ width: '100%', minHeight: '60vh', overflow: 'hidden' }}>
          <div className="absolute inset-0">
            <Image src="/services/infant-massage.jpg" alt="Kūdikių hipertonusas" fill priority quality={95} sizes="100vw"
