...
export default function VaikuKineziterapijaPage() {
  ...
  const pageText = {
    ...
    en: {
      ...
      sign1: 'Child complains of back, neck, knee or foot pain (after school, sport, growth spurts).',
      sign2: 'You notice posture changes: "hunching", shoulder or pelvic asymmetry, "crooked" posture.',
      sign3: 'You suspect postural disorders: scoliosis, increased kyphosis or excessive spinal curves.',
      sign4: 'You notice leg axis changes: "O" or "X" shaped legs (knees turning inward / outward).',
      sign5: 'You notice foot problems: arch disorders, signs of flat feet, "tilting" heels, uneven shoe wear.',
      sign6: 'Child tires quickly, avoids active movement, often sits "incorrectly".',
      sign7: 'After injury or strain — you want a safe return to sport and daily activity.',
      sign8: 'Coordination is poorer: child falls often, "can\'t" run, jump, throw, quickly loses control.',
      sign9: 'You feel "something is off" — you want a clear assessment and plan.',
      whenNote: 'We clearly explain what we see and what we will do — no "guessing" and no conveyor belt.',
      whatWeHelpTitle: 'What we help with',
      whatWeHelpSubtitle: 'Briefly and clearly — choose the situation that best fits your child:',
      situation1: 'Postural disorders (scoliosis, increased kyphosis)',
      situation1desc: 'When posture changes or spinal curves are visible — we assess movement and compensations, select corrections and exercise plan.',
      situation2: '"O" and "X" shaped leg axis',
      situation2desc: 'When knees or legs turn inward / outward — we work with supports, muscle balance and movement control.',
      situation3: 'Foot arch disorders (flat feet etc.)',
      situation3desc: 'When the arch "drops", heels tilt, shoes wear unevenly — we strengthen foot and calf muscles, correct supports and gait habits.',
      situation4: 'Pain during growth',
      situation4desc: 'When pain occurs after load or growth spurts — we look for the cause (load, support, posture) and correct so it doesn\'t recur.',
      situation5: 'Coordination and movement quality',
      situation5desc: 'When coordination, balance, movement control is lacking — we train stability and movement confidence.',
      situation6: 'Sport preparation and return after injury',
      situation6desc: 'Safe return to sport: strength, stability, technique, load planning and preventive habits.',
      situation7: 'Consequences of injuries and surgeries (per doctor\'s recommendations)',
      situation7desc: 'Rehabilitation by stage, so mobility, strength and function return.',
      situation8: 'Motor development disorders',
      situation8desc: 'When the child struggles to reach certain movement milestones — we work with muscle activation, coordination and functional skill building.',
      situation9: 'Neurological conditions (per doctor\'s recommendations)',
      situation9desc: 'When there are neurological disorders — we help improve motor control and function, aligning goals with the family.',
      situation10: 'Obesity and overweight',
      situation10desc: 'Safe movement plan: gradual activity increase, support and stability strengthening, sustainable habits.',
      situation11: 'Chronic back and joint pain',
      situation11desc: 'When pain recurs — we strengthen "weak links", teach correct movement strategies and load management.',
      ctaRegister: 'Register for visit',
      ctaCall: '+370 666 99676',
      sessionTitle: 'How does a visit with a child work?',
      sessionDesc: 'We adapt the visit to the child\'s age, character and goals. We assess posture, movement quality, supports, stability, coordination and load tolerance — then clearly explain what we see and what we\'ll do next.',
      sessionDuration: 'How a visit works (45–60 min)',
      sessionPoints: [
        'Assessment and functional tests by situation.',
        'Clear explanation: what matters most and why.',
        'Targeted work (exercises / corrections) based on the goal.'
      ],
      parentsTitle: 'Parents\' role',
      parentsDesc: 'Parents are an active part of the process: we show what and how to do at home, how to adjust daily habits (sitting, backpack, activity, sport).',
      afterTitle: 'What you get after the visit',
      after1: 'A clear answer: what is happening and what matters most now.',
      after2: 'An individual plan and recommended frequency.',
      after3: 'Practical recommendations for home and sport: what to change, what to avoid, what to do.',
      ruleTitle: '"15 minutes" principle (no rushing)',
      ruleDesc: 'For children, trust and connection matter. If needed — we take breaks, change tasks, adapt to the child\'s pace. We care not only about the exercise programme but also the child\'s emotional state — so we work calmly, without pressure and without a "conveyor belt".',
      methodTitle: 'Our methodology',
      methodDesc: 'We work based on clinical assessment and select tools based on what we actually see in movement.',
      method1: 'Clinical functional assessment',
      method1desc: 'We assess posture, supports, stability, coordination and movement control — so the plan is accurate, not "generic for everyone".',
      method2: 'DNS methodology',
      method2desc: 'Helps improve supports, stability and movement quality — especially in posture, foot and pain situations where a solid "foundation" for movement is needed.',
      method3: 'Vojta therapy (applied as needed)',
      method3desc: 'We apply in certain cases where more precise neuromuscular activation is needed. We always explain to parents why we choose this method and what to expect.',
      method4: 'Parent education',
      method4desc: 'Daily corrections often bring the most progress between visits: sitting, backpack, activity, movement habits at home and school.',
      visitsTitle: 'How many visits will be needed?',
      visitsDesc: 'Children\'s bodies adapt quickly — sometimes a few targeted corrections are enough, and sometimes a consistent plan is needed, especially if there is pain, posture, foot or sport goals.',
      visit1: '1 consultation',
      visit1desc: 'thorough assessment + clear plan + first corrections for daily life.',
      visit2: '3–5 visits',
      visit2desc: 'monitoring and adjustment as new habits form and load changes.',
      ...
      q1: 'From what age is children\'s physiotherapy suitable?',
      a1: 'We usually work with children from ~2 years. If the situation is individual — contact us, we\'ll advise.',
      q2: 'Is a doctor\'s referral needed?',
      a2: 'No, a referral is not required. If you have a doctor\'s conclusions or tests — bring them.',
      q3: 'How long is a visit?',
      a3: 'Usually 45–60 min, depending on the situation and child\'s age.',
      q4: 'How to prepare for a visit?',
      a4: 'Comfortable clothes for movement. If the child does sport — you can bring sport shoes. If there\'s pain — describe when and after what.',
      q5: 'Can parents be present?',
      a5: 'Yes — we even recommend it, so corrections transfer to daily life.',
      q6: 'Can we come if the child is sick?',
      a6: 'If there is fever or acute infection — better to reschedule. If in doubt — write, we\'ll advise.',
      q7: 'How often should we visit?',
      a7: 'Usually: 1 consultation + a few follow-up visits. Exact frequency is set after assessment.',
